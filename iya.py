...
satpam.login(token="EoEotPek4lM5NMKfD4v4.QXYHCXzQnIXP72luipN3Ha.ridulK4ZnbBIdR40beneGUm7Sn6IKoWhxqv/H5Sm29k=")
satpam.loginResult()
...
ki = LINETCR.LINE()
ki.login(token="EotVKTEKVZWAtq23CZkc.eoXp0xK1vqkdnL9Q78yCpa.ShYU/jHVNaTheCV/EaJqh9GYpq85omBs3f4OjJwgvCQ=")
ki.loginResult()
